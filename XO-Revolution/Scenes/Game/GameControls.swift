...
struct GameControls {
	...
	/// Buttons and Labels Classic Neon Skin
	...
	init(inThisScene: GameScene) {
        ...
        if UIDevice.current.userInterfaceIdiom == .phone || UIDevice.current.deviceType == .iPad || UIDevice.current.deviceType == .iPad2 || UIDevice.current.deviceType == .iPadMini {
            ...
            net.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*47.39/100))
            ...
            halloweenNet.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*47.39/100))
            ...
            octoberNet.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*47.39/100))
            ...
            /// Resizing depending to device Ipad screen
            if UIDevice.current.userInterfaceIdiom == .pad  || UIDevice.current.deviceType == .simulator {
                ...
                net.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*50/100))
                ...
                halloweenNet.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*50/100))
                ...
                octoberNet.position = CGPoint(x: gameScene.size.width/2, y: (gameScene.size.height*50/100))
