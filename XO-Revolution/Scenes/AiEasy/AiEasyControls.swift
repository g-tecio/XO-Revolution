...
struct AiEasyControls {
    ...
    init(inThisScene: AiEasyScene) {
        ...
        if UIDevice.current.userInterfaceIdiom == .phone || UIDevice.current.deviceType == .iPad || UIDevice.current.deviceType == .iPad2 || UIDevice.current.deviceType == .iPadMini {
            ...
            halloweenNet.position = CGPoint(x: aiEasyScene.size.width/2, y: (aiEasyScene.size.height*47.39/100))
            ...
            octoberNet.position = CGPoint(x: aiEasyScene.size.width/2, y: (aiEasyScene.size.height*47.39/100))
            ...
            if UIDevice.current.userInterfaceIdiom == .pad  || UIDevice.current.deviceType == .simulator {
                ...
                halloweenNet.position = CGPoint(x: aiEasyScene.size.width/2, y: (aiEasyScene.size.height*50/100))
                ...
                octoberNet.position = CGPoint(x: aiEasyScene.size.width/2, y: (aiEasyScene.size.height*50/100))
