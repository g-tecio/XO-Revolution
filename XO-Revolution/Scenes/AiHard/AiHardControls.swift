...
struct AiHardControls {
    ...
    init(inThisScene: AiHardScene) {
        ...
        net.zPosition = 2
        net.position = CGPoint(x: aiHardGameScene.size.width/2, y: (aiHardGameScene.size.height*4.5/10))
        ...
        buttonMenu.position = CGPoint(x: inThisScene.size.width*9/10, y: (inThisScene.size.height*9/10))
